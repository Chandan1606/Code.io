...
const Navbar = ({ isGridLayout, setIsGridLayout }) => {
  ...
  return (
    <>
      <div className="navbar flex items-center justify-between px-[100px] h-[80px] bg-[#061621]">
        <div className="logo">
        ...
        <div className="links flex items-center gap-3">
          ...
          <Avatar onClick={() => { toggleClass(".dropDownNavbar", "hidden") }} name={data ? data.name : ""} size="45" round="50%" className=' cursor-pointer ml-2' />
        </div>
